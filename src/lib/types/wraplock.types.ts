...
@Struct.type("addcontract")
export class Addcontract extends Struct {
    @Struct.field(Name) native_token_contract!:Name
    @Struct.field(Name) paired_wraptoken_contract!:Name
}
...
@Struct.type("contract_mapping")
export class ContractMapping extends Struct {
    @Struct.field(Name) native_token_contract!:Name
    @Struct.field(Name) paired_wraptoken_contract!:Name
}

@Struct.type("delcontract")
export class Delcontract extends Struct {
    @Struct.field(Name) native_token_contract!:Name
}
